...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_wordpresstest_f258ddc204a2cfab4623_20221207125245_archive.zip';
        const ARCHIVE_SIZE       = '32254484';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f258ddc-07125245';
        const SECONDARY_PACKAGE_HASH = '35ba61f-07125245';
        const VERSION            = '1.5.1';
